...
4.  时间标记。必须标记一个明确的、影响后续一组事件的宏观时间转变，您必须输出一行单独的时间标记文本，格式为 时间描述文本，例如 7月1日、2023年8月15日、2023年8月15日到18日等这种具体的时间描述，不得模糊（某天、次日、任务当天等），若前文未提及可以自行合理编造一个时间点。此标记行不带序号和权重。脚本处理时可以自行决定如何使用这些时间标记。
